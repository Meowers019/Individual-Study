...
static constexpr PressureToTempRangeF R22_PT_TABLE_F[] = {
    {0, 50, 0},      {50, 52, 1},       {52, 54, 3},     {54, 56, 4},
    {56, 58, 6},     {58, 60, 7},       {62, 64, 10},    {64, 66, 11},
    {66, 68, 12},    {68, 70, 14},      {70, 72, 15},    {72, 74, 16},
    {74, 76, 17},    {76, 78, 18},      {78, 80, 20},    {80, 85, 21},
    {85, 90, 24},    {90, 95, 26},      {95, 100, 29},   {100, 105, 31},
    ...
    {500, 525, 134}, {525, 10000, 1000} // Catch-all for out-of-range
};

static constexpr size_t R22_PT_TABLE_COUNT =
    sizeof(R22_PT_TABLE_F) / sizeof(R22_PT_TABLE_F[0]);

// ===================== LOOKUP FUNCTIONS =====================
// Convert R-22 pressure to saturation temperature
inline float r22PsiToSaturationTempF(float psi) {
  if (isnan(psi) || psi < 0.0f)
    return NAN;
