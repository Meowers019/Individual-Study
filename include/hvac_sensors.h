...
inline void updateHvacPressures(HvacPressures &hvacPressures) {
  ...
  bool a0Ok = readPressureSensorA0Psi(hvacPressures.highSidePressurePsi); // A0 = High Side. TD33
  bool a1Ok = readPressureSensorA1Psi(hvacPressures.lowSidePressurePsi);  // A1 = Low Side.  TD1000
...
inline void updateHvacSaturationTempsFromPressures(
  ...
  hvacSatTemps.lowSideSatTempF  = psiToSaturationTempF(hvacPressures.lowSidePressurePsi);
  hvacSatTemps.highSideSatTempF = psiToSaturationTempF(hvacPressures.highSidePressurePsi);
